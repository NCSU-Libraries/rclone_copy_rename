# rclone_copy_rename
SCRC uses rclone to download donor files from Google Drive, which allows for duplicate file names. If files with duplicate names are present, they will be skipped.
